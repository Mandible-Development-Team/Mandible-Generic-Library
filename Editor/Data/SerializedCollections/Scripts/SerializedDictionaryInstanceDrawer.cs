using Mandible.Core.Data.Editor.Data;
using Mandible.Core.Data.Editor.States;
using Mandible.Core.Data.KeysGenerators;
using System;
...
namespace Mandible.Core.Data.Editor
{
    public class SerializedDictionaryInstanceDrawer
    {
        ...
        {
            if (property == null || type == null) return (DisplayType.PropertyNoLabel, false);
        ...
        {
            if(property == null || _activeState == null) return;
